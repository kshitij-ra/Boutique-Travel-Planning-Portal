...
const AboutUs = (props) => {
  return (
    <div className="about-us-container">
      <Helmet>
        <title>About-Us - T84 Travel Agency</title>
        <meta property="og:title" content="About-Us - T84 Travel Agency" />
      </Helmet>
      <div className="about-us-top-container">
        <nav data-role="Header" className="about-us-navbar">
          <h1 className="about-us-logo">T84 Travels</h1>
          <div className="about-us-right-side">
            <div className="about-us-links-container">
              <Link to="/" className="about-us-navlink">
                Home
              </Link>
              <Link to="/all-destinations" className="about-us-navlink1">
                Destinations
              </Link>
              <Link to="/local-guides" className="about-us-navlink2">
                Local Guides
              </Link>
              <Link to="/packages-builder" className="about-us-navlink3">
                Package Builder
              </Link>
            </div>
          ...
          <div data-role="BurgerMenu" className="about-us-burger-menu">
            <svg viewBox="0 0 1024 1024" className="about-us-burger-menu1">
            ...
            <div className="about-us-nav">
              ...
              <div className="about-us-right-side1">
                <div className="about-us-links-container1">
                  ...
                  <Link to="/all-destinations" className="about-us-navlink5">
                    Destinations
                  </Link>
                  <Link to="/packages-builder" className="about-us-navlink6">
                    Package Builder
                  </Link>
                  <Link to="/local-guides" className="about-us-navlink7">
                    Local Guides
                  </Link>
                </div>
        ...
        <div className="about-us-hero">
          <div className="about-us-content-container">
            <h1 className="Heading about-us-text1">About Us</h1>
          </div>
        </div>
      </div>
      <div id="main-section" className="about-us-main">
        <div className="about-us-container1">
          <h1>TO-DO: add text and images</h1>
        </div>
        <WorkWithUsBanner rootClassName="work-with-us-banner-root-class-name4"></WorkWithUsBanner>
      </div>
